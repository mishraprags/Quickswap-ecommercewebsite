"""
Django settings for quickswap_project project.
...
ALLOWED_HOSTS = ['2320395g.pythonanywhere.com']
...
ROOT_URLCONF = 'quickswap_project.urls'
...
WSGI_APPLICATION = 'quickswap_project.wsgi.application'
